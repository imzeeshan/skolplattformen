# [2.2.0](https://github.com/imzeeshan/skolplattformen/compare/v2.1.0...v2.2.0) (2024-08-26)


### Bug Fixes

*  removed price components. Altered QA. ([#653](https://github.com/imzeeshan/skolplattformen/issues/653)) ([fef71c7](https://github.com/imzeeshan/skolplattformen/commit/fef71c7923c1f406c57ed0e15cde4df2d8ff9676))
* 🐛 Add better logo image for Freja eID ([051df2d](https://github.com/imzeeshan/skolplattformen/commit/051df2da3955c87df3b75fe11a83c5dd966519e0))
* 🐛 Add languages to curriculum config ([b9302f9](https://github.com/imzeeshan/skolplattformen/commit/b9302f96faaf71c797ec335018d9952e26e9d267))
* 🐛 Add missing translations for calendar ([7ada994](https://github.com/imzeeshan/skolplattformen/commit/7ada9945dfc7dd5766cd7a3208d62cf4c1a2659f))
* 🐛 Add translation to week ([cfa39de](https://github.com/imzeeshan/skolplattformen/commit/cfa39de3934e2386d90f37ad2c3dc830106e175a))
* 🐛 added dist to ignore ([1230825](https://github.com/imzeeshan/skolplattformen/commit/1230825571462a69d00b24f8bae0d6d82f0f5784))
* 🐛 Added projects to nx ([c88b25a](https://github.com/imzeeshan/skolplattformen/commit/c88b25aa102549d8a59fd9e7e0b6af293620378b))
* 🐛 adjust fakeData lessons offset in ht ([#598](https://github.com/imzeeshan/skolplattformen/issues/598)) ([3f69bc8](https://github.com/imzeeshan/skolplattformen/commit/3f69bc89aaa7eb1cf4ade789551667b960ff8825))
* 🐛 BankID urls changed ([#646](https://github.com/imzeeshan/skolplattformen/issues/646)) ([25a2d7f](https://github.com/imzeeshan/skolplattformen/commit/25a2d7f3f5c9fd8fc32f0cdbdab37ffce64da44b))
* 🐛 Better fix for the isoWeek bug in Timetable ([ea6b385](https://github.com/imzeeshan/skolplattformen/commit/ea6b385b4f56a4565796fab15afa71e00cea2a9e))
* 🐛 Bytte ut Freja eID till Freja eID+. Lade till polska ([a611460](https://github.com/imzeeshan/skolplattformen/commit/a6114608edfc464aa3bca4b13733d10c11bb934d))
* 🐛 Change broken links caused by name change of repo ([#649](https://github.com/imzeeshan/skolplattformen/issues/649)) ([61d47b4](https://github.com/imzeeshan/skolplattformen/commit/61d47b44406b6af3585c933ef0f964311026be09))
* 🐛 Clarify who's personal identity number to enter ([5028a85](https://github.com/imzeeshan/skolplattformen/commit/5028a85824f4d73ab8007caaeca32a439f4f360e)), closes [#526](https://github.com/imzeeshan/skolplattformen/issues/526)
* 🐛 dummy login i hjarntorget ([38cc762](https://github.com/imzeeshan/skolplattformen/commit/38cc7626adcbb79bf2dcb74c6a98666c44b37f69))
* 🐛 error loading SKOLA24_CHILDREN SAML ([508b079](https://github.com/imzeeshan/skolplattformen/commit/508b0792a10eeac065dd798182f3f4dcf20a27ca))
* 🐛 Felaktig sortering av lektioner ([#595](https://github.com/imzeeshan/skolplattformen/issues/595)) ([ed3a27b](https://github.com/imzeeshan/skolplattformen/commit/ed3a27bba185b39fd8581b639ac7efc03b050d6e)), closes [#591](https://github.com/imzeeshan/skolplattformen/issues/591)
* 🐛 fix crash when moment locale and language code differ ([623bf48](https://github.com/imzeeshan/skolplattformen/commit/623bf483b52a54a6199e6607248b948b775b6e7b))
* 🐛 Fix failing test in Curriculum ([8724fa4](https://github.com/imzeeshan/skolplattformen/commit/8724fa46b714d8ad2804c23e39c801cadc21d488))
* 🐛 Fix failing tests ([8d9cfe2](https://github.com/imzeeshan/skolplattformen/commit/8d9cfe2de4ebc2b21584d2cbf930e83857b24263))
* 🐛 fix for iOS ([8e3a9c1](https://github.com/imzeeshan/skolplattformen/commit/8e3a9c139034bdec50d3f9df0f41dd79d49abb8b))
* 🐛 Fixes crash when body od newItem is empty ([3e0fd14](https://github.com/imzeeshan/skolplattformen/commit/3e0fd1474a719382627270a1305110692f9ff99b))
* 🐛 Fixes failing tests (added skip), fixes lint + test ([d71c106](https://github.com/imzeeshan/skolplattformen/commit/d71c10607f6a4b89b582b81258fc9c0fc20bf2a8))
* 🐛 Fixes inheritance from [@skolplattformen-api](https://github.com/skolplattformen-api) ([ba45cfd](https://github.com/imzeeshan/skolplattformen/commit/ba45cfd79685fc61b2477f5a3aa9416ba11a1200))
* 🐛 Fixes issue with package.json in hjarntorget ([e2e1ff8](https://github.com/imzeeshan/skolplattformen/commit/e2e1ff82787f967b8c1e8845363291732cae59be))
* 🐛 Fixes lint errors ([e19c8a7](https://github.com/imzeeshan/skolplattformen/commit/e19c8a7747153bbc204efd6cef42b3929cf376d0))
* 🐛 Fixes merge with main ([c54f2ff](https://github.com/imzeeshan/skolplattformen/commit/c54f2ffd05589ffbebba5e50b9aef4649bfa9b58))
* 🐛 Fixes news title, lowered font size on header ([7df15d3](https://github.com/imzeeshan/skolplattformen/commit/7df15d36b12a82484e903ecb39e38795013ce72c))
* 🐛 Fixes tests ([d451cf1](https://github.com/imzeeshan/skolplattformen/commit/d451cf13afbf5e4d1fca43c45d3938d11503d394))
* 🐛 Fixes tests, added esModuleInterop true to tsconfig ([6383795](https://github.com/imzeeshan/skolplattformen/commit/63837955a33e3e913b6c88a72ae3c37d95d6b321))
* 🐛 Fixes TS config + lint etc ([4663269](https://github.com/imzeeshan/skolplattformen/commit/46632691bf506199e3e51696e1e26a8c53c42e37))
* 🐛 Fixes TSconfig for all projects ([24c1624](https://github.com/imzeeshan/skolplattformen/commit/24c162419b4768564052fcab662c9aa81d46e8f3))
* 🐛 Fixes tsconfig in api-hjarntorget ([b641486](https://github.com/imzeeshan/skolplattformen/commit/b641486768323baf60a0100b838689cb7a6bee77))
* 🐛 Fulfix. Login funkar ([c5bec5f](https://github.com/imzeeshan/skolplattformen/commit/c5bec5f9eee06fd1c47b7993ff9aab3d10771276))
* 🐛 Hide lunch in timetable if not showing current week ([#613](https://github.com/imzeeshan/skolplattformen/issues/613)) ([a40af3e](https://github.com/imzeeshan/skolplattformen/commit/a40af3e94d236bd61272319f0b1e8e5e19cd3a2c)), closes [#599](https://github.com/imzeeshan/skolplattformen/issues/599)
* 🐛 Ingen text syns i dark mode när inga barn hittas ([bce1165](https://github.com/imzeeshan/skolplattformen/commit/bce1165f300749502351fe28ee8f0c5f3ce7ee3c)), closes [#571](https://github.com/imzeeshan/skolplattformen/issues/571)
* 🐛 merge ([d26fd62](https://github.com/imzeeshan/skolplattformen/commit/d26fd62e5c7640148f6ba3ef65db1ea3aa6fb274))
* 🐛 merge conflict ([cafe6ec](https://github.com/imzeeshan/skolplattformen/commit/cafe6ec990087dffe828f03be7c9b003709e2197))
* 🐛 Merge with master ([9d21341](https://github.com/imzeeshan/skolplattformen/commit/9d213413bee88a126134557f654bbb7edab4ad46))
* 🐛 Öppna på Android utan originAppScheme ([30b5bbb](https://github.com/imzeeshan/skolplattformen/commit/30b5bbb51efb31f67ffc5c4665d6933ec51fba5a))
* 🐛 pt translations from curriculum ([#616](https://github.com/imzeeshan/skolplattformen/issues/616)) ([8d1ad62](https://github.com/imzeeshan/skolplattformen/commit/8d1ad6283972ddb8f9d5275ebe76523a0f64aff4))
* 🐛 Readded keystore ([47c2ca3](https://github.com/imzeeshan/skolplattformen/commit/47c2ca30dcd780437e4f71af317da1c89258ad3d))
* 🐛 Readded mock, ts config to api ([82e0c6f](https://github.com/imzeeshan/skolplattformen/commit/82e0c6f961301c9241cf2ecacb657dbf53326f4f))
* 🐛 Removed auth-test ([06c29d7](https://github.com/imzeeshan/skolplattformen/commit/06c29d75da5e6b503b98c949bf32f78027ee7548))
* 🐛 removed dist prior to ignore, more lint errors fix ([78f7577](https://github.com/imzeeshan/skolplattformen/commit/78f757783f7c3215eae7cdbbb3a33dd5063a1d2a))
* 🐛 Rensa sessionen innan Freja login ([bc2625d](https://github.com/imzeeshan/skolplattformen/commit/bc2625dc598594f004c9d193a653514020533866))
* 🐛 scroll in timetable ([#597](https://github.com/imzeeshan/skolplattformen/issues/597)) ([f844a3c](https://github.com/imzeeshan/skolplattformen/commit/f844a3cdd4ea26b6a4b76e4236debec7e6e83986))
* 🐛 Show subject name on Hjärntorget timetable ([b3df527](https://github.com/imzeeshan/skolplattformen/commit/b3df527d44904b7838bcb0a9aaef69c276c9c5b7))
* 🐛 Show the weekday on startpage if not today ([df28066](https://github.com/imzeeshan/skolplattformen/commit/df2806648ab6b573d277a338f76fb199cdd307a2))
* 🐛 Site moved to new url ([c93e27b](https://github.com/imzeeshan/skolplattformen/commit/c93e27bec05582be2c0b0e63ba5ab47b1688b8d8))
* 🐛 spelling of chinese traditional in chinese traditional ([a28fd97](https://github.com/imzeeshan/skolplattformen/commit/a28fd97fe7907a591dc92f5ddeccf1045b4f794b))
* 🐛 Store childs personalIdNumbers in settings ([cc3fd86](https://github.com/imzeeshan/skolplattformen/commit/cc3fd8670c37be2b5f3e9f642bb3b1882350e2f6))
* 🐛 translations for curriculum ([#614](https://github.com/imzeeshan/skolplattformen/issues/614)) ([93c1c2d](https://github.com/imzeeshan/skolplattformen/commit/93c1c2d0b0831b44d20991be270172caccce195c))
* 🐛 Tweak retry in Hooks lib to exponential with 7 retries ([5577c7f](https://github.com/imzeeshan/skolplattformen/commit/5577c7fe425c2f2700ff32b39185a40e62952b87))
* 🐛 Updated Timetable URLs ([#659](https://github.com/imzeeshan/skolplattformen/issues/659)) ([e6ba622](https://github.com/imzeeshan/skolplattformen/commit/e6ba622fa9d5c7ec533a71fe5b1fab6687a8fefe))
* 🐛 Upgraded async-storage from 1.5.2 to 1.5.9 ([0cd72f5](https://github.com/imzeeshan/skolplattformen/commit/0cd72f5d84bd76b846d99ac7995eba3bec154866))
* 🐛 Week component height and cap text ([9874dda](https://github.com/imzeeshan/skolplattformen/commit/9874dda30eefca652685419668374e1b460ffc51))
* 🐛 Week starts on monday regardless of selected locale ([#642](https://github.com/imzeeshan/skolplattformen/issues/642)) ([7e8ee95](https://github.com/imzeeshan/skolplattformen/commit/7e8ee956f4c638c9b51e033b75d808c2d8d8e62d))
* add missing package references ([d41e2e3](https://github.com/imzeeshan/skolplattformen/commit/d41e2e3efe278415f3afc462b721afbec4b6f1e2))
* auth issues ([ae369c2](https://github.com/imzeeshan/skolplattformen/commit/ae369c204c2b6dccdb84c85fd2c6f10dd76bdc8e))
* Bitrise build ([10e993a](https://github.com/imzeeshan/skolplattformen/commit/10e993ab9dc375d813479efae6b5d30a6fc06b60))
* change jest config for api's ([e50b991](https://github.com/imzeeshan/skolplattformen/commit/e50b991f54443beaaf9d4390f6efe0ff111ca033))
* copyright year ([#657](https://github.com/imzeeshan/skolplattformen/issues/657)) ([20ae87f](https://github.com/imzeeshan/skolplattformen/commit/20ae87fee165d9c4c9f9b77c28003226e5255e92))
* failing html parsing ([2a2259a](https://github.com/imzeeshan/skolplattformen/commit/2a2259a2608ef7e9420d9d3fa59f55530d662ae9))
* fetch typings ([97e131d](https://github.com/imzeeshan/skolplattformen/commit/97e131d30d1c021ecf88aafc98820cdaec70fa67))
* fix failing tests in `api` ([57f38f5](https://github.com/imzeeshan/skolplattformen/commit/57f38f5b84537b35f13d0c4a6b72c7d2c80074b5))
* fix test configuration ([e6f213a](https://github.com/imzeeshan/skolplattformen/commit/e6f213a89f84b1eb3aafdd3d5d0971aceb10dbca))
* images cropping on different devices ([#524](https://github.com/imzeeshan/skolplattformen/issues/524)) ([7c50988](https://github.com/imzeeshan/skolplattformen/commit/7c5098859b71f13ffdb9441b81e149b983355d9f))
* licenses extractor is used on the correct package.json ([d1de447](https://github.com/imzeeshan/skolplattformen/commit/d1de44775b9df6132af9974f6aaef09c5f2d678f))
* lint and prettier fixes ([169b536](https://github.com/imzeeshan/skolplattformen/commit/169b5365e94cd0ff5fe2aa9f28a7baebaeba899a))
* package.json name for app changed ([a867b11](https://github.com/imzeeshan/skolplattformen/commit/a867b116c802956b5f5a8b6ec55e64e6821eb475))
* remove deps/lock file for vklass ([ffd73e8](https://github.com/imzeeshan/skolplattformen/commit/ffd73e8362edcebb2e0f02944c3ebf560e96b33d))
* remove unused e2e files ([97b4380](https://github.com/imzeeshan/skolplattformen/commit/97b438069a589abc37a96fe8c10ce23078b30e7b))
* rename and fix imports ([18ed862](https://github.com/imzeeshan/skolplattformen/commit/18ed8620af5b396eeed740058531ebafda4f8d64))
* some failing tests in hooks now works ([c122f28](https://github.com/imzeeshan/skolplattformen/commit/c122f281a9607d7a52b3a25718e93151ddd7768a))
* ui-kitten metro config ([5fdc3d7](https://github.com/imzeeshan/skolplattformen/commit/5fdc3d71adb8d9364c8c6b345de841f0f3f1de7c))
* update github workflow to run nx instead of lerna ([289c2f8](https://github.com/imzeeshan/skolplattformen/commit/289c2f848aec44da03692d4119aa9e1544dc9292))


### Features

* 🎸 activate norwegian ([cec7ddd](https://github.com/imzeeshan/skolplattformen/commit/cec7ddd8601309f752f9fe49298fcc96643599b7))
* 🎸 Add Thai curriculum ([#622](https://github.com/imzeeshan/skolplattformen/issues/622)) ([bd02b37](https://github.com/imzeeshan/skolplattformen/commit/bd02b378c0d73f116baa716d05786c5d5d5cfbd9))
* 🎸 Add week number and calendar dates to timetable ([6fbbcc8](https://github.com/imzeeshan/skolplattformen/commit/6fbbcc803e92e288904be1ffba5e380bd9523100))
* 🎸 Added food menu to features ([bec62fa](https://github.com/imzeeshan/skolplattformen/commit/bec62fa21b9503927b44ad956314a888fa6923e1))
* 🎸 Added privacy policy for Öppna Elevappen on the site ([6eb6d3a](https://github.com/imzeeshan/skolplattformen/commit/6eb6d3a6e3b62d1ee1aabb46e6f514cc4ec909e8))
* 🎸 Added Thai translation ([#621](https://github.com/imzeeshan/skolplattformen/issues/621)) ([9e2f94d](https://github.com/imzeeshan/skolplattformen/commit/9e2f94d8532af4b427aaea8335c4c3775ecb853b))
* 🎸 Ämnesnamn syns nu i schemat i Hjärntorget. ([#596](https://github.com/imzeeshan/skolplattformen/issues/596)) ([14ff985](https://github.com/imzeeshan/skolplattformen/commit/14ff985b0c7a0c9ab9c8547679caff66c7b5aa1f))
* 🎸 Bara visa Freja om det finns tillgängligt i api ([0c64f5a](https://github.com/imzeeshan/skolplattformen/commit/0c64f5ae35d1a2d1a8cd0b16bda942e9fd619e3f))
* 🎸 bump to RN 0.66 + upgrade dependencies ([#521](https://github.com/imzeeshan/skolplattformen/issues/521)) ([f05ff64](https://github.com/imzeeshan/skolplattformen/commit/f05ff646870c441717ca23f7fbe17a931c3ad452))
* 🎸 bump to version 2.0.4 ([6d762e7](https://github.com/imzeeshan/skolplattformen/commit/6d762e70076c292d952f1b626ea2925caaac78f9))
* 🎸 bump to version 2.0.4 ([078c946](https://github.com/imzeeshan/skolplattformen/commit/078c946a441a4227033c24acbb17807ea19a4dae))
* 🎸 bumped to 3.0.2 for new version releasea ([2af189e](https://github.com/imzeeshan/skolplattformen/commit/2af189ef0fb23723dae982382bee169e2c7ed8f6))
* 🎸 Chinese (simplified and traditional) ([eed2a75](https://github.com/imzeeshan/skolplattformen/commit/eed2a7579c23629c0e8dbd8350fa971cec3753fb))
* 🎸 Clear personal cache on login and logout ([#572](https://github.com/imzeeshan/skolplattformen/issues/572)) ([bf29ab5](https://github.com/imzeeshan/skolplattformen/commit/bf29ab58edd13db62b34f873a3429d319c0e7297))
* 🎸 Feature toggle context ([ce05682](https://github.com/imzeeshan/skolplattformen/commit/ce056821a1b1d562e4c36d7ff30dfcb5e3ad3aeb))
* 🎸 Fix image load and typescript errors ([#570](https://github.com/imzeeshan/skolplattformen/issues/570)) ([933a884](https://github.com/imzeeshan/skolplattformen/commit/933a8840a3ebd049711a000ca6faf3e534f77ace))
* 🎸 fixes ts issues ([3f62016](https://github.com/imzeeshan/skolplattformen/commit/3f62016d6add2f5f234d6125c002b4d4603a5783))
* 🎸 Freja logo om login button ([170b4da](https://github.com/imzeeshan/skolplattformen/commit/170b4da39ae771953824a5c9be72c843ede96714))
* 🎸 Hämta lärare och skolkontakter från api-skolplattfomen och visa lärarens namn i schemat ([#589](https://github.com/imzeeshan/skolplattformen/issues/589)) ([b7dbd35](https://github.com/imzeeshan/skolplattformen/commit/b7dbd356c652bf53a9d73dd38f11744ff364470b))
* 🎸 Japanese ([e5deadd](https://github.com/imzeeshan/skolplattformen/commit/e5deadd88084fba26a7b8dbc83664be376b76a51))
* 🎸 japanese in curriculum ([#617](https://github.com/imzeeshan/skolplattformen/issues/617)) ([1d1e871](https://github.com/imzeeshan/skolplattformen/commit/1d1e8713f4f2861e994158ff5830615e6d1e7727))
* 🎸 language updates for curriculum ([4d62d9e](https://github.com/imzeeshan/skolplattformen/commit/4d62d9e26987ae4840f81e1c1ad958a6905746c0))
* 🎸 Latin and fix for locales ([1c05196](https://github.com/imzeeshan/skolplattformen/commit/1c051961d695ebb2546f2a30991d01015e7c48fb))
* 🎸 Logga in med Freja eID+ ([d9c62a6](https://github.com/imzeeshan/skolplattformen/commit/d9c62a6d91abc30b376fc9233108655a0da9fd5b))
* 🎸 Merged with main, also added api to nx ([4f1f66f](https://github.com/imzeeshan/skolplattformen/commit/4f1f66fcbbf3682004e781d058ff43a7eb3b57ce))
* 🎸 Portuguese ([2f45cbd](https://github.com/imzeeshan/skolplattformen/commit/2f45cbdeb639cd43c6b13cff0a2f86a934b950dd))
* 🎸 Rätt text för rätt inloggning i modal ([be22fd8](https://github.com/imzeeshan/skolplattformen/commit/be22fd8cd35b4086b80758df132036f2d5957382))
* 🎸 Skip to the next day in calendar ([#425](https://github.com/imzeeshan/skolplattformen/issues/425)) ([fce1d98](https://github.com/imzeeshan/skolplattformen/commit/fce1d98847f4cc7c27bfa359b1d2b1bdc86e12ea))
* 🎸 Somali ([df8f2e3](https://github.com/imzeeshan/skolplattformen/commit/df8f2e378e76d1f4b8f4b0cfd55aba82626ccaa8))
* 🎸 Started on provider for selecting platform + feature to ([1aaaeb6](https://github.com/imzeeshan/skolplattformen/commit/1aaaeb64e31531185c0ef75bff61c97f0cf942c4))
* 🎸 Toggled class list in hjärntorget ([33440bc](https://github.com/imzeeshan/skolplattformen/commit/33440bcc32d0ea466662cdf167406b0dd503b251))
* 🎸 Ukrainska ([8b2b680](https://github.com/imzeeshan/skolplattformen/commit/8b2b680c175f95c54fb945fba06d798cc881c809))
* 🎸 wip feagture toggle ([1601c4f](https://github.com/imzeeshan/skolplattformen/commit/1601c4f83c75bc98ec1084725f9b126e871024b2))
* 🎸 WIP Switch school platform ([916ebc5](https://github.com/imzeeshan/skolplattformen/commit/916ebc5e25b52eebf45a147f971356d8bd9e2e11))
* add nx build system ([d90cfd2](https://github.com/imzeeshan/skolplattformen/commit/d90cfd2a3b94b9845f809b65a96a72b10447651c))
* Frontpage date tweaks ([#582](https://github.com/imzeeshan/skolplattformen/issues/582)) ([66e7811](https://github.com/imzeeshan/skolplattformen/commit/66e7811b83e96f9fb83aa82cb34736f38a3bf16a))
* navigate from "Your Children" to specific tabs ([#660](https://github.com/imzeeshan/skolplattformen/issues/660)) ([34c376a](https://github.com/imzeeshan/skolplattformen/commit/34c376a727ad0bbfbd3f7be01aedb91d1705b34b))
